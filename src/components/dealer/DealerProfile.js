  ...
  const updateUserData = () => {
    ...
    UserService.update(id, data)
      .then(response => {
        ...
        navigate('/dashboard/dealer/profile');
      })
      .catch(e => {
        console.log(e);
      });
            ...
            <div className='row'>
              <div className="col-md-10">
                <div className="form">
                    ...
                    <div className="col-sm-8">
                    <select className="form-select" name="province_id" id="province_id" required onChange={handleInputChange, handleProvinceOnly} value={currentUser.province_id}>
